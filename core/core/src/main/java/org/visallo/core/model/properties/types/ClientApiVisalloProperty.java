...
public abstract class ClientApiVisalloProperty<TClientApi> extends VisalloProperty<TClientApi, String> {
    private final Class<TClientApi> clazz;

    public ClientApiVisalloProperty(String key, Class<TClientApi> clazz) {
        super(key);
        this.clazz = clazz;
    }
